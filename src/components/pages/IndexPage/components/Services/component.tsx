import { Box, Button, Paper, styled, Toolbar, Typography } from '@mui/material';
...
export const Component: FC = () => {
  return (
    <div id={'services'}>
      ...
      <Wrapper sx={{ pt: 4 }}>
        <SectionHeading>
          <Typography variant={'subtitle1'}>サービス</Typography>
          ...
          <Paper elevation={0} sx={{ p: 4, backgroundColor: grey[100] }}>
            ...
            <Box sx={{ mt: 2 }}>
              <Typography variant={'caption'}>
                <sup>※</sup>{' '}
                湯使いとは施設ごとに異なる「源泉の扱い方」を表し、Yuumiesでは「加水・加温・循環濾過・添加物（薬剤、入浴剤等）」の4項目の有無で表現します。
              </Typography>
            </Box>
          </Paper>
          <Businesses>
