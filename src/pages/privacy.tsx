  ...
  <Layout>
    ...
    <Box sx={{ my: 4 }}>
      ...
      <Typography variant={'body1'}>
        株式会社 enkake (以下，「当社」といいます。) は，本ウェブサイト上で提供するサービス
        (以下,「本サービス」といいます。)
      ...
      <Typography variant={'body1'}>
        当社は，ユーザーが利用登録をする際に氏名，生年月日，住所，電話番号，メールアドレス，銀行口座番号，クレジットカード番号，運転免許証番号などの個人情報をお尋ねすることがあります。また，ユーザーと提携先などとの間でなされたユーザーの個人情報を含む取引記録や決済に関する情報を,当社の提携先
...
export const Head: HeadFC = () => <SEO title={'プライバシーポリシー'} />;
