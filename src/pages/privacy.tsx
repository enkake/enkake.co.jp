...
const Page: React.FC<PageProps> = () => (
  <Layout>
    <Toolbar />
    <Box sx={{ my: 4 }}>
      <Typography variant={"h4"} sx={{ mb: 4 }} component={'h1'}>プライバシーポリシー</Typography>
      <Typography variant={'body1'}>
        株式会社 enkake (以下，「当社」といいます。) は，本ウェブサイト上で提供するサービス (以下,「本サービス」といいます。) における，ユーザーの個人情報の取扱いについて，以下のとおりプライバシーポリシー (以下，「本ポリシー」といいます。) を定めます。
      </Typography>
